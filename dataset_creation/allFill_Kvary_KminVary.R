...
fwrite(merged_lm, file = paste(today, "RegSummary_allFill_Kvary_KminVary.csv", sep = "_"), sep = ",", col.names = TRUE)
...
fwrite(SlopeSum_Gen, file = paste(today, "MeansProps_allFill_Kvary_KminVary.csv", sep = "_"), sep = ",", col.names = TRUE)
