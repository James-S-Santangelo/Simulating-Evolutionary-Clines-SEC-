...
bot = float(0) # Proportion of alleles sampled upon creation of new populations (i.e. bottleneck proportion)

max_p_create = float(0) # Maximum probability of creating a new population. Decreases with population size. See 'prob_create' function in Functions.py

r = float(math.log(1.5)) # Natural rate of increase. Enter desired instantaneous population growth rate (e.g. 2 is a doubling every generation).
